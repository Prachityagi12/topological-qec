...
An encoding circuit was constructed for the logical state $|0_L\rangle$.
...
Therefore, the circuit successfully prepares the encoded logical $|0_L\rangle$ state.
...
After completing the current Surface Code implementation, the repository will be extended toward:

* Color Code implementation and simulation
* Comparison of Toric, Surface, and Color Codes
* Further investigation of decoder performance and code-distance scaling
* Extensions toward fault-tolerant quantum error correction
